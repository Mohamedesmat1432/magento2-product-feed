...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    private function changeUpdateAtColumn($setup)
    {
        $setup->getConnection()->changeColumn(
            $setup->getTable(\Nourcode2\ProductFeed\Model\ResourceModel\ProductFeed::NOURCODE2_PRODUCT_FEED_TABLE),
            'updated_at',
            'updated_at',
            [
    ...
    {
        $setup->getConnection()->changeColumn(
            $setup->getTable(\Nourcode2\ProductFeed\Model\ResourceModel\Logs::NOURCODE2_PRODUCT_FEED_LOGS_TABLE),
            'feed_name',
            'filename',
            [
    ...
    {
        $feedTable = $setup->getTable(\Nourcode2\ProductFeed\Model\ResourceModel\ProductFeed::NOURCODE2_PRODUCT_FEED_TABLE);
        $columns = [
            "header_generated" => [
