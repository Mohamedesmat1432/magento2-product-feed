define([
    'jquery',
    'underscore',
    'Nourcode2_ProductFeed/js/lib/codemirror',
    'Magento_Ui/js/modal/modal',
    'mage/translate',
    'Nourcode2_ProductFeed/js/mode/xml/xml',
    'Nourcode2_ProductFeed/js/addon/display/autorefresh',
    'Nourcode2_ProductFeed/js/addon/mode/overlay',
    'jquery/ui'
], function ($, _, modal, $t) {
    "use strict";
    ...
    $.widget('nourcode2.initTemplateTab', {
        /**
    ...
    return $.nourcode2.initTemplateTab;
});
