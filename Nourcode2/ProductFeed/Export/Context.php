<?php
namespace Nourcode2\ProductFeed\Export;

use Nourcode2\ProductFeed\Export\Step\StepFactory;
use Nourcode2\ProductFeed\Helper\Io;
use Nourcode2\ProductFeed\Model\Config;
...
class Context
{
    ...
    /**
     * @var \Nourcode2\ProductFeed\Model\ResourceModel\ProductFeed
     */
    protected $feed;
     ...
     * Set feed model
     *
     * @param \Nourcode2\ProductFeed\Model\ProductFeed $feed
     * @return $this
     */
     ...
     * Root step
     *
     * @return \Nourcode2\PRoductFeed\Export\Step\AbstractStep
     */
